...
const serviceData: Record<string, ServiceInfo> = {
  ...
  tagline: 'Press tool and die engineering for sheet metal components',
  support: 'Optimized for forming accuracy, tool life, and production efficiency.',
  industries: ['Automotive', 'Electrical', 'Plumbing', 'General Engineering'],
  ...
  keyServices: [
    ...
    { title: 'Die Layout Design', desc: 'Punch and die layout optimized for material flow, accuracy, and repeatable production.' },
    { title: 'Tool Optimization', desc: 'Die clearance, stripper, and tool life improvement for existing sheet metal tooling.' },
  ],
  process: ['Component Study', 'Die Layout', 'Tool Design', 'Optimization', 'Final Drawings'],
  capabilities: [
    'Press tool and die design for blanking, piercing, and forming',
  ...
  whyEmpic: [
    ...
    'Production-ready press tool and die detailing',
    'Accuracy and tool life verified at design stage',
    'Experience across blanking, piercing, bending, and forming',
  ],
  cta: 'Need press tool or die design support?',
},
};
